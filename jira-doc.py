...
def get_current_sprint():
    ...
    print (jira.search_issues('project=JD and status="Done" and Sprint="13" ORDER BY status DESC, updated DESC'))
    print (jira.search_issues('project=JD and status="Done" and Sprint="Sprint 13" ORDER BY status DESC, updated DESC'))
    sprint = ''
    status = ''
    empty_list = []
